...
| :--- | :--- | :--- | :---: | :--- |
| **Qt 6** | 6.10.2 | LGPL-3.0 / commercial | **Yes** | Permitted under LGPL-3.0 dynamic linking rules. |
| **PoDoFo** | 0.10.3+ | LGPL-2.0+ OR MPL-2.0 | **Yes** | Permitted under LGPL/MPL dynamic linking rules. |
| **OpenSSL** | 3.x | Apache-2.0 | **Yes** | Permitted, Apache-2.0 license compatible. |
| **PDFium** | ANY | BSD-3-Clause | **Yes** | Permitted, BSD-3-Clause is extremely permissive. |
| **qpdf** | 12.3.2 | Apache-2.0 | **Yes** | Permitted, Apache-2.0 license compatible. |
| **Tesseract** | 5.x | Apache-2.0 | **Yes** | Permitted, Apache-2.0 license compatible. |
| **Leptonica** | 1.87.0 | BSD-2-Clause | **Yes** | Permitted, BSD-2-Clause is extremely permissive. |
